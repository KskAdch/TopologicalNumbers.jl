...
"""
function calcChernSurface(H::Function, kn::String; kn_mesh::Int=51, N::Int=51, gapless::Real=0.0, rounds::Bool=true, parallel::T=UseSingleThread(), plot::Bool=false) where {T<:TopologicalNumbersParallel}
