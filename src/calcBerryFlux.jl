...
'''
'''math
f_{n}(\bm{k})=\frac{1}{2\pi}\mathrm{Im}\mathrm{Log}\left[U_{n,1}(\bm{k})U_{n,2}(\bm{k}+\bm{e}_{1})U_{n,1}^{*}(\bm{k}+\bm{e}_{2})U_{n,1}^{*}(\bm{k})\right]
'''
'''math
df_{n}(\bm{k})=\frac{1}{2\pi}\mathrm{Im}\left(\mathrm{Log}U_{n,1}(\bm{k})+\mathrm{Log}U_{n,2}(\bm{k}+\bm{e}_{1})-\mathrm{Log}U_{n,1}(\bm{k}+\bm{e}_{2})-\matthrm{Log}U_{n,1}(\bm{k})\right)
```
